...
export const servicePages: ServicePage[] = [
  {
    ...
    features: [
      'Personal de carga altamente capacitado and de absoluta confianza.',
      'Flota de camiones propia equipada con mantas de lana pesada and film alveolar.',
      'Desarme and armado profesional de mobiliario complejo.',
      'Servicio opcional de embalaje de vajilla and cristalería delicada.',
  ...
  },
  {
    ...
    features: [
      ...
      'Facturación corporativa and documentación en regla.'
    ]
  },
  {
    ...
    features: [
      'Envoltura individual de objetos delicados and piezas de cristalería.',
      'Film stretch para proteger sillones and colchones del polvo and suciedad.',
      'Canastos and cajas reforzadas diseñadas especialmente para mudanzas.',
  ...
  },
  {
    ...
    features: [
      'Unidades individuales, limpias and libres de humedad.',
      'Monitoreo con cámaras de seguridad and alarmas perimetrales las 24 horas.',
  ...
  },
  {
    ...
    features: [
      ...
      'Rotulado estricto and separación física interna de cada lote.',
      'Salidas semanales and coordinadas en las rutas principales del país.',
  ...
  },
  {
    ...
    features: [
      'Reparto capilar and entregas de última milla programadas.',
      'Gestión de inventario and almacenamiento temporal de mercaderías.',
      'Vehículos modernos con habilitación CNRT and municipal correspondiente.',
