...
export default function Footer({ destinations, onNavigate }: FooterProps) {
  ...
  return (
    <footer className="bg-[#0D0D0D] text-slate-300 border-t border-white/10" aria-label="Información de Mudanzas Miranda">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16 grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12 items-start">
        <section aria-labelledby="footer-brand-title" className="space-y-6">
          <h2 id="footer-brand-title" className="text-sm font-bold text-white uppercase tracking-wider">Mudanzas Miranda</h2>
        ...
        <section aria-labelledby="footer-contact-title" className="space-y-4">
          <h2 id="footer-contact-title" className="text-sm font-bold text-white uppercase tracking-wider">Contacto</h2>
        ...
        <nav aria-labelledby="footer-services-title" className="space-y-4">
          <h2 id="footer-services-title" className="text-sm font-bold text-white uppercase tracking-wider">Nuestros Servicios</h2>
        ...
        <nav aria-labelledby="footer-coverage-title" className="space-y-4">
          <h2 id="footer-coverage-title" className="text-sm font-bold text-white uppercase tracking-wider">Lugares principales</h2>
