      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16 grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12 items-start">
        <div className="space-y-6">
          <div className="space-y-3">
            <a href="/" onClick={(e) => { e.preventDefault(); handleLinkClick(''); }} className="flex items-center cursor-pointer block">
          ...
          <div className="space-y-3 text-sm">
            <div className="flex items-start gap-2">
              ...
              <a href="https://maps.google.com/?q=Armada+Argentina+584,+Mendoza,+Argentina" target="_blank" rel="noopener noreferrer" className="text-slate-300 hover:text-amber-500 transition-colors leading-relaxed">Armada Argentina 584, Mendoza, AR</a>
            </div>
            <div className="flex items-center gap-2"><Phone className="w-4 h-4 text-amber-500 flex-shrink-0" /><a href="tel:+5492615130910" className="text-slate-300 hover:text-amber-500 transition-colors font-medium">+54 9 261 513-0910</a></div>
            <div className="flex items-center gap-2"><Mail className="w-4 h-4 text-amber-500 flex-shrink-0" /><a href="mailto:info@mudanzasmiranda.com.ar" className="text-slate-300 hover:text-amber-500 transition-colors">info@mudanzasmiranda.com.ar</a></div>
          </div>
          ...
          <div className="space-y-2 pt-4 border-t border-white/10 text-sm">
            ...
            <div className="grid grid-cols-2 gap-3 text-slate-300">
              <div><p className="font-semibold">Lun a Vie</p><p className="text-xs text-slate-400">08:00 - 20:00</p></div>
      ...
      <div className="bg-[#0A0A0A]/80 border-t border-white/5 py-8">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 flex flex-col sm:flex-row items-center justify-between gap-4 text-xs text-slate-500">
          ...
          <div className="flex items-center gap-4">
            ...
            <a href="https://www.facebook.com/mudanzasmiranda4" target="_blank" rel="noopener noreferrer" className="p-2 rounded-lg hover:text-white hover:bg-white/5 transition-all" aria-label="Facebook de Mudanzas Miranda"><Facebook className="w-5 h-5 text-amber-500" /></a>
          </div>
        </div>
      </div>
    </footer>
