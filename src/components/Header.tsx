        ...
        <div className="flex items-center justify-between">
          ...
          <nav className="hidden lg:flex items-center gap-1">
            <button
              ...
              className={`px-4 py-2 rounded-xl text-sm font-semibold transition-all cursor-pointer ${
                activePage === '' ? 'text-amber-500 bg-white/10' : 'text-slate-300 hover:text-white hover:bg-white/5'
              }`}
            >
              Inicio
            </button>
            ...
            <div className="relative">
              <button
                ...
                className={`px-4 py-2 rounded-xl text-sm font-semibold text-slate-300 hover:text-white hover:bg-white/5 transition-all flex items-center gap-1 cursor-pointer ${
                  activePage !== '' ? 'text-amber-500 bg-white/5' : ''
                }`}
              >
                Destinos
          ...
          <div className="hidden lg:flex items-center gap-3">
            <a
              ...
              className="flex items-center gap-1.5 text-slate-300 hover:text-white text-sm font-medium border border-white/10 hover:bg-white/5 px-3.5 py-2 rounded-xl transition-all"
            >
      ...
      {isMobileMenuOpen && (
        <div className="lg:hidden fixed inset-0 top-[65px] bg-[#0A0A0A] z-40 flex flex-col p-6 animate-in slide-in-from-right duration-200 overflow-y-auto border-t border-white/10">
          <nav className="flex flex-col gap-3">
            <button
              ...
              className={`w-full text-left py-3 px-4 rounded-xl text-base font-semibold ${
                activePage === '' ? 'text-amber-500 bg-white/5' : 'text-slate-300'
              }`}
            >
              Inicio
            </button>
            <a
              ...
              className="py-3 px-4 rounded-xl text-base font-semibold text-slate-300 hover:bg-white/5"
            >
              Nosotros
            </a>
            <a
          ...
          <div className="mt-auto space-y-3 pt-6 border-t border-white/10">
            <a
              href="tel:+5492615130910"
              className="w-full flex items-center justify-center gap-2 text-slate-300 font-semibold border border-white/10 py-3 rounded-xl hover:bg-white/5"
            >
