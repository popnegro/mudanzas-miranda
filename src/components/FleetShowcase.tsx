export default function FleetShowcase() {
  return (
    <section
      className="relative isolate flex min-h-[440px] items-end overflow-hidden border-b border-line bg-neutral-900 bg-cover bg-center sm:min-h-[520px] sm:bg-[position:center_40%] lg:min-h-[600px]"
    ...
    >
      ...
      <div className="relative z-10 w-full max-w-7xl mx-auto px-4 py-10 sm:px-6 sm:py-14 lg:px-8 lg:py-16">
        <div className="max-w-xl space-y-4 sm:space-y-5">
          <span className="inline-flex items-center gap-1.5 rounded-md border border-white/25 bg-white/12 px-2.5 py-1 font-mono text-[10px] font-bold uppercase tracking-widest text-white/90 backdrop-blur-sm">
          ...
          <div className="flex flex-col gap-3 pt-2 sm:flex-row sm:items-center sm:gap-4">
            <div className="inline-flex w-fit items-center gap-2 rounded-xl border border-white/25 bg-white/12 px-4 py-2 text-xs font-semibold text-white/90 backdrop-blur-md">
