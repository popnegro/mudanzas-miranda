...
export const servicePages: ServicePage[] = [
  {
    ...
    description: 'Servicio de mudanzas residenciales en Mendoza. Mudamos casas, departamentos en altura y dúplex. Embalaje profesional, personal cuidadoso y seguro de carga.',
    ...
    detailText: 'Mudar un hogar requiere planificación. Nuestro equipo técnico se encarga del desarme de camas, placares y escritorios, etiquetado inteligente de bultos y una estiba optimizada dentro de camiones totalmente alfombrados y equipados con amarres de alta resistencia. Además, contamos con seguro de carga incluido para el traslado, según las condiciones de la cobertura correspondiente.',
    features: [
  ...
  },
  {
    ...
    heroSubheadline: 'Logística empresarial coordinada para organizar el traslado y reducir interrupciones en la operación.',
  ...
  },
  {
    ...
    description: 'Protección de tus bienes durante la mudanza. Embalaje con film alveolar, plástico burbuja, cajas reforzadas y canastos para vajilla en Mendoza.',
    heroHeadline: 'Embalaje Profesional y Protección Activa',
    heroSubheadline: 'Utilizamos materiales adecuados para proteger tus pertenencias según el tipo de objeto.',
  ...
  },
  {
    ...
    description: 'Consultá por modalidades de mudanza combinada y grupal según ruta y disponibilidad. Salidas frecuentes desde Mendoza a Buenos Aires, Córdoba y el país.',
    ...
    features: [
      'Modalidad compartida sujeta a ruta, disponibilidad y condiciones de contratación.',
  ...
  },
  {
    ...
    heroSubheadline: 'Soporte logístico para comercios y pymes que necesitan coordinar traslados y entregas en Mendoza.',
