...
# Imports: keep React state, remove effects once routing/carousel are delegated.
...
# Remove local routing/carousel state.
...
# Replace the existing carousel effect.
...
# Replace URL synchronization effect and navigation function as one block.
...
# Replace duplicated SEO derivation with the extracted helper.
...
# Keep carousel controls behavior while delegating state ownership to the hook.
